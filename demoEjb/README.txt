...
a persistence unit "demoEjbPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "demoEjb/pom.xml":
...
artifact ("demoEjb.war") is already built. You can build
