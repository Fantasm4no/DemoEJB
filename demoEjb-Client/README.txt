...
a persistence unit "demoEjb-ClientPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "demoEjb-Client/pom.xml":
...
artifact ("demoEjb-Client.war") is already built. You can build
